...
//        if (Physics.Raycast(transform.position + (Vector3.up * 0.5f) + Vector3.left * .5f, Vector3.forward, out hitInfo, m_ForwardCheckDistance) || Physics.Raycast(transform.position + (Vector3.up * 0.5f) + Vector3.right * .5f, Vector3.forward, out hitInfo, m_ForwardCheckDistance))
//        {

//                // Left Box
//                if (hitInfo.transform.GetComponentInParent<Item>().itemType == ItemTypes.BoxLeft)
//                {
//                    EscortState = PlayerState.LeftMove;
//                    return;
//                }
//            // Right Box
//            else if (hitInfo.transform.GetComponentInParent<Item>().itemType == ItemTypes.BoxRight)
//                {
